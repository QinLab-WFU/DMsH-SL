...
def main():
    ...
    model = CANet(32,60,"resnet50").cuda()

    # model = cnn_model.CNNNet("alexnet", 64, 30)
    # https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_base_patch4_window7_224.pth
    weights_path = "/home/admin01/桌面/CAN/para_model/MLRS32/best.pth"
    ...
    # load image
    img_path = "/home/admin01/桌面/CAN/data/MLRS/image/lake/lake_00057.jpg"
