...
parser.add_argument('--ds', default='MLRS', choices=['cifar10', 'cifar100', 'imagenet100', 'nuswide','AID','DFC15','UCMD','MLRS'],
                    help='dataset')
# loss related
...
parser.add_argument('--seed', default=3407, help='seed number; default: 420')
...
config = {
    ...
    'multiclass': True,
    'dataset_kwargs': {
        'resize': 256 if args.ds in ['nuswide' , 'UCMD'] else 224,
        'crop': 224,
        'norm': 2,
